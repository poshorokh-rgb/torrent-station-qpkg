...
const I18N = {
  ru: {
    ...
    tb_standby: "Standby",
    tb_resume_all: "Возобновить",
    standby_title: "Остановить все передачи",
    standby_resume_title: "Возобновить передачи, остановленные Standby",
    toast_standby: "Все передачи остановлены",
    toast_standby_resumed: "Передачи возобновлены",
    ...
    col_status: "Статус",
    col_added: "Добавлен",
    col_added_date: "Дата добавления",
    col_down: "Загрузка",
    col_up: "Отдача",
    col_eta: "Осталось",
    col_ratio: "Рейтинг",
    col_peers: "Сиды/Пиры",
    col_seeds_short: "Сиды",
    col_peers_short: "Пиры",
    col_downloaded: "Скачано",
    col_uploaded: "Отдано",
    col_remaining: "Осталось скачать",
    col_location: "Папка",
    col_completed: "Завершён",
    col_files: "Файлов",
    col_private: "Приватный",
    col_error: "Ошибка",
    columns_title: "Колонки",
    columns_hint: "Отметьте нужные и измените порядок",
    columns_reset: "Сбросить",
  ...
  en: {
    ...
    tb_standby: "Standby",
    tb_resume_all: "Resume",
    standby_title: "Stop all transfers",
    standby_resume_title: "Resume transfers stopped by Standby",
    toast_standby: "All transfers stopped",
    toast_standby_resumed: "Transfers resumed",
    ...
    col_seeds_short: "Seeds",
    col_peers_short: "Peers",
    ...
    columns_hint: "Choose columns and adjust their order",
    columns_reset: "Reset",
