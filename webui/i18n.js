...
const I18N = {
  ru: {
    ...
    categories_catalog_title: "Категории",
    categories_catalog: "Каталог",
    categories_for: (name) => `Категории для «${name}»`,
    categories_for_many: (n) => `Категории для ${n} торрент(ов)`,
    categories_target: (n) => `Выбрано торрент(ов): ${n}`,
    categories_labels: "Категории / метки",
    categories_selected: "Выбрано",
    categories_empty: "Нет категорий",
    categories_quick: "Быстрый выбор",
    categories_search: "Поиск категорий",
    categories_search_ph: "Начните вводить название",
    categories_no_matches: "Нет совпадений",
    categories_new: "Новая категория",
    categories_new_ph: "Например: Сериалы",
    categories_add: "Добавить",
    categories_delete_action: "Удалить категорию",
    categories_delete_title: "Удалить категорию?",
    categories_delete_checking: "Проверяем, где назначена категория…",
    categories_delete_message: (label, n) => `Категория «${label}» будет снята с ${n} торрент(ов). Это действие нельзя отменить.`,
    categories_delete_empty_message: (label) => `Категория «${label}» есть только в локальном каталоге и будет удалена из него.`,
    categories_delete_confirm: "Удалить категорию",
    ...
    details_edit_category: "Изменить",
    details_refresh: "Обновить",
    details_refresh_title: "Обновить список файлов",
    details_first_file: (name, pct) => `First: ${name} · ${pct}%`,
    details_first_note: "Остальные файлы временно в «Пропустить» и возобновятся автоматически после завершения этого файла.",
    d_status: "Статус",
    d_size: "Размер",
    ...
    priority_first_active: "First включён: остальные файлы возобновятся автоматически после завершения этого",
    priority_first_verify_failed: "Не удалось перевести все остальные файлы в Skip. First не включён.",
    ...
    window_drop_title: "Отпустите, чтобы добавить торрент",
    window_drop_hint: "Файл .torrent будет добавлен сразу",
  ...
  en: {
    ...
    categories_catalog_title: "Categories",
    categories_catalog: "Catalog",
    categories_for: (name) => `Categories for “${name}”`,
    categories_for_many: (n) => `Categories for ${n} torrent(s)`,
    ...
    categories_quick: "Quick pick",
    categories_search: "Search categories",
    categories_search_ph: "Start typing a name",
    categories_no_matches: "No matches",
    categories_new: "New category",
    categories_new_ph: "For example: Series",
    categories_add: "Add",
    categories_delete_action: "Delete category",
    categories_delete_title: "Delete category?",
    categories_delete_checking: "Checking category assignments…",
    categories_delete_message: (label, n) => `“${label}” will be removed from ${n} torrent(s). This cannot be undone.`,
    categories_delete_empty_message: (label) => `“${label}” exists only in the local catalog and will be removed from it.`,
    ...
    details_edit_category: "Edit",
    details_refresh: "Refresh",
    details_refresh_title: "Refresh file list",
    details_first_file: (name, pct) => `First: ${name} · ${pct}%`,
    details_first_note: "Other files are temporarily set to Skip and will resume automatically after this file finishes.",
    d_status: "Status",
    d_size: "Size",
    ...
    priority_high: "High",
    priority_first: "First",
    priority_first_active: "First is active: other files will resume automatically when this file finishes",
    priority_first_verify_failed: "Could not set every other file to Skip. First was not enabled.",
    ...
    window_drop_title: "Drop to add torrent",
    window_drop_hint: "The .torrent file will be added immediately",
